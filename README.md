...
- Unleashed Recompiled ([GitHub](https://github.com/hedge-dev/UnleashedRecomp))
...
### Linux/Steam Deck
Checkout [Hedge Mod Manager 8 Beta](https://github.com/hedge-dev/HedgeModManager) for playing with mods on the Steam Deck!
