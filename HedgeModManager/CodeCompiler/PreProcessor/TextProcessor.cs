...
namespace HedgeModManager.CodeCompiler.PreProcessor
{
    public class TextProcessor
    {
        ...
        {
            var builder = new StringBuilder();
            var readers = new Stack<LineReader>();
            readers.Push(new LineReader(BasicLexer.FilterComments(text.AsMemory())));
                                ...
                                case "include":
                                    {
                                        ...
                                        if (includeToken.IsKind(SyntaxTokenKind.StringLiteralToken))
                                        {
                                            ...
                                            if (includeText != null)
                                            {
                                                readers.Push(new LineReader(BasicLexer.FilterComments(includeText.AsMemory())));
                                            }
                                        }
                                        else
                                        {
